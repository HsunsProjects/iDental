...
{
    /// <summary>
    /// TPlasterModel5s.xaml 的互動邏輯
    /// </summary>
    public partial class TPlasterModel5s : UserControl
    {
        ...
        public TPlasterModel5s(Agencys agencys, Patients patients, Templates templates, DateTime templateImportDate)
        {
            InitializeComponent();
